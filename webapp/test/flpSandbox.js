		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#gitdemoproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gitdemoproject2-display": {
								"semanticObject": "gitdemoproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gitdemoproject2",
									"url": sap.ui.require.toUrl("gitdemoproject2")
								}
							}
						}
					}
